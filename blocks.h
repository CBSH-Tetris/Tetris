...
namespace tetris {
	...
	block blk[7] = {
		block({0, 0}, {1, 0}, {2, 0}, {0, 1}), 		// L
		block({0, 0}, {1, 0}, {2, 0}, {0, -1}),		// J
		block({0, 0}, {0, 1}, {1, 0}, {1, 1}), 		// O
		block({0, 0}, {1, 0}, {0, 1}, {-1, 1}), 	// S
		block({0, 0}, {1, 0}, {0, -1}, {-1, -1}), 	// Z
		block({0, 0}, {1, 0}, {2, 0}, {-1, 0}), 	// I
		block({0, 0}, {1, 0}, {0, -1}, {0, 1}) 		// T
	};
}